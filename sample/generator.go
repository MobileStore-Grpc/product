...
func NewMobile() *pb.Mobile {
	brand := randomMobileBrand()
	name := randomMobileName(brand)
	mobile := &pb.Mobile{
		Id:          randomID(),
		Brand:       brand,
		Name:        name,
		...
		Screen:      NewScreen(),
		Weight:      &pb.Mobile_WeightKg{WeightKg: randomFloat64(1.0, 4.0)},
		PriceInr:    randomFloat64(1500, 3000),
		ReleaseYear: uint32(randomInt(2020, 2021)),
	}
	return mobile
}
